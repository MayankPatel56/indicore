...
const shopLinks = [
  ...
  { label: 'New Arrivals', page: 'products' as const, params: { sort: 'newest' } },
  { label: 'Best Sellers', page: 'products' as const, params: { sort: 'popular' } },
];
...
const serviceLinks = [
  ...
  { label: 'Shipping Info', page: 'contact' as const },
  { label: 'Returns', page: 'contact' as const },
...
export default function Footer() {
  ...
  const handleLinkClick = (page: string, params?: Record<string, string>) => {
    navigate(page as 'home' | 'products' | 'contact', params);
